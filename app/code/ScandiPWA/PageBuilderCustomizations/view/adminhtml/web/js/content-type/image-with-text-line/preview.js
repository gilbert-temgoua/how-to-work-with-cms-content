    ...
    var Preview =
        ...
        function (_preview2) {
            ...
            _proto.initWysiwyg = function initWysiwyg(element) {
                ...
                config.adapter.settings.fixed_toolbar_container = "#" + this.contentType.id + " .pagebuilder-image-with-text-attribute-content";
                (0, _factory)(this.contentType.id, element.id, this.config.name, config, this.contentType.dataStore, "content", this.contentType.stageId).then(function (wysiwyg) {
            ...
            _proto.onTextareaFocus = function onTextareaFocus() {
                (0, _jquery)(this.textarea).closest(".pagebuilder-image-with-text-attribute-content").addClass("pagebuilder-toolbar-active");
            ...
            _proto.onTextareaBlur = function onTextareaBlur() {
                (0, _jquery)(this.textarea).closest(".pagebuilder-image-with-text-attribute-content").removeClass("pagebuilder-toolbar-active");
            ...
            _proto.bindEvents = function bindEvents() {
                ...
                _events.on(this.config.name + ":" + this.contentType.id + ":updateAfter", function () {
                    ...
                    if (dataStore.content === "<div data-bind=\"html: data.content.html\">&nbsp;</div>") {
                        _this4.contentType.dataStore.set("content", "");
                    }

                    (0, _nestingLinkDialog)(_this4.contentType.dataStore, _this4.wysiwyg, "content", "link_url");
                });
            }
            /**
